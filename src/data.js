...
export const projects = [
    ...
    {
      title: "Bakery Store Website",
      subtitle: "A Simple React Bakery Store Website",
      description:
        "Online shopping through apps and websites has become very popular nowadays. Here, I designed a bakery shopping shop that is intuitive and easy to use. Users can easily use the filtering buttons and sorting fields to find their desired items. The total price is calculated and interface is transparent.",
