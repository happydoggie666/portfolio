...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative"  style={{marginTop: "3rem"}}>
      <div className="container px-3 py-10">
        <div className="row">
          <div className="col-lg-6 col-xs-12 px-5 py-10" data-aos="fade-up">
            <h3 class="display-7 fw-bold" style={{color:"#4682B4"}}>Contact</h3>
          ...
          <div className="col-lg-6 col-xs-12" data-aos="fade-up">
            <div className="row " style={{height: "100%"}}>
              <div style={{height: "10%"}}><h3 class="display-7 fw-bold" style={{color:"#4682B4"}}>Address</h3></div>
